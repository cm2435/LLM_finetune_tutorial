...
class ScriptArguments:
    ...
    hub_path: Optional[str] = field(default=None, metadata={"help" : "huggingface hub path to push to."})
...
if script_args.hub_path is not None:
    print("Merging to hub")
    model.push_to_hub(f"{script_args.hub_path}", use_temp_dir=False)